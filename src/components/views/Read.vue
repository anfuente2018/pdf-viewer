  ...
  <div>
    ...
    <div v-show="show_read == true">
      <div class="field center">
        <b-switch v-model="is_auto" type="is-primary">
          Busqueda automatica
        </b-switch>
      </div>
      ...
      <section v-if="is_auto == false">
        ...
        >
          ...
          >
            <p class="buttons center">
              <a
                ...
                :key="index"
                @click="next(`company:${item.name_internal}`)"
              >
          ...
          >
            <p class="buttons center">
              <a
                class="button is-large btnmaxx"
                v-for="(item, index) in names"
                :key="index"
                @click="next(`type:${item.name}`)"
              >
                <span class="icon is-medium">
                  <i class="fas fa-folder"></i>
                </span>
          ...
          >
            <p class="buttons center">
              <a
                ...
                :key="index"
                @click="next(`bank:${item.name_internal}`)"
              >
                <span class="icon is-medium">
                  <i class="fas fa-folder"></i>
                </span>
          ...
          <b-tab-item
            ...
            icon="calendar-alt"
            icon-pack="fas"
            :disabled="isactivetab[3]"
            class="tabitem"
          >
            <p class="buttons center">
              <a
                class="button is-large btnmax"
                v-for="(item, index) in years"
                :key="index"
                @click="next(`year:${item}`)"
              >
                <span class="icon is-medium">
                  <i class="fas fa-folder"></i>
                </span>
          ...
          >
            <p class="buttons center">
              <a
                ...
                :key="index"
                @click="finalize(`month:${item.name}`)"
              >
                <span class="icon is-medium">
                  <i class="fas fa-folder"></i>
                </span>
          ...
          >
            <p class="buttons center">
              <a
                ...
                :key="index"
                @click="downloadFileForId(item.id, item.name)"
              >
                <span class="icon is-medium">
      ...
      <div v-else>
        ...
        <section>
          <p class="buttons center">
            <a
              class="button is-large"
              v-for="(item, index) in datatempfilter"
              :key="index"
              @click="downloadFileForId(item.id, item.name)"
            >
              <span class="icon is-medium">
          ...
          <div class="card">
            <div class="card-content">
              <div class="block center">
                ...
                <a
                  class="button space"
                  @click="page != numPages ? page++ : (page = page)"
                >
                  <span class="icon is-small">
                ...
                <b-tag type="is-info" size="is-medium" class="space"
                  >{{ page }}/{{ numPages }}</b-tag
                >
            ...
            <div class="card-content">
              ...
              <div v-if="show_edit == 'all'" class="space-v">
                <div class="has-text-centered">
                  <a
                    @click="extractAll()"
                    class="button is-vcentered is-medium is-info is-outlined is-rounded"
                    >Extraer todas las paginas</a
                  >
                  <div class="has-text-centered space-v">
                    <a
                      @click="backRead()"
                      class="button is-vcentered is-small is-warning is-rounded"
                      >Volver</a
                    >
                  </div>
                </div>
              ...
              <div v-else class="space-v">
                <div class="is-scrollable">
                  <b-field
                    grouped
                    v-for="(item, index) in nro_divider"
                    :key="index"
                  >
                ...
                <div class="has-text-centered space-v-min">
                  <a
                    @click="clearDivider()"
                    class="button is-small is-vcentered is-primary is-outlined is-rounded"
                    >Limpiar</a
                  >
                  <a
                    @click="addDivider()"
                ...
                <div class="field center space-v-min">
                  <b-checkbox v-model="is_join"
                    >Unir todas las paginas</b-checkbox
                  >
                </div>
                ...
                <div class="has-text-centered space-v-min">
                  <a
                    @click="go()"
                    class="button is-vcentered is-medium is-success is-outlined is-rounded"
                    >Dividir por rango</a
                  >
                </div>
  ...
  data() {
    return {
      ...
      names: [
        ...
        {
          name: 'Cheques Manuales',
          abv: 'CHEQUES_MANUALES',
          bank: false
        },
        {
